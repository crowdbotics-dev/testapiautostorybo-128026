...
## Project Structure
    ...
    ├── testapiautostorybo_128026  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_128026`
...
2. Clone this repo and `cd testapiautostorybo_128026`
